export default {
  records: [
    {
      id: 'recABcfKRUaQWszKp',
      fields: {
        Name: 'Hand hygiene system',
        Client: ['rec11y8gfRvfu4vvY'],
    ...
    {
      id: 'recAtEBIM2S1xJOTI',
      fields: {
        Name: 'B11 bike saddle',
        Client: ['recZX2W9SteEl8usP'],
    ...
    {
      id: 'recCCf40ubqK5RB1R',
      fields: {
        Name: 'Flapper brand identity',
        Client: ['recruJAePGdsImUSt'],
    ...
    {
      id: 'recCDh5nK96DltZfC',
      fields: {
        Name: '443 Huntington brand identity',
        Client: ['recNfJea19JoRaE8c'],
        Category: 'Industrial design',
        'Project team': [
          {
            id: 'usr8e9aJ8jHSg29YV',
    ...
    {
      id: 'recHgyLZv169LZ0vw',
      fields: {
        Name: 'Gotham City Parks brand identity',
        Client: ['recLAt297dnigWM57'],
        Category: 'Brand identity',
        Complete: true,
        'Project team': [
          {
    ...
    {
      id: 'recORjK8MasiRs6jF',
      fields: {
        Name: 'Convertible 3000 laptop',
        Client: ['recLkzvXH3hrA6qN4'],
    ...
    {
      id: 'recUUzZUG3XIjdtwX',
      fields: {
        Name: 'RITI media lab logo',
        Client: ['recU2SW7MyyOvKu1J'],
        Category: 'Industrial design',
        Complete: true,
        'Project team': [
          {
    ...
    {
      id: 'recVevNSwDzBRtLWp',
      fields: {
        Name: 'New Door brand identity',
        Client: ['rec1aJj1xLW0T4UmR'],
        Category: 'Brand identity',
        Complete: true,
        'Project team': [
          {
    ...
    {
      id: 'recYAyavVEMB2QISF',
      fields: {
        Name: 'Premier utility bike',
        Client: ['rechnujlm56efsUdg'],
        Category: 'Industrial design',
        'Project team': [
          {
    ...
    {
      id: 'recdNo8TzXvXujwos',
      fields: {
        Name: 'Lemon headband',
        Client: ['recVdJ0bUM7oEPmUC'],
        Category: 'Technology design',
        'Project team': [
          {
            id: 'usr6hWARwVNgmt3WW',
        ...
        Tasks: ['recTt6NajB8jJArLb', 'rec2gFlWEd1DfQdlC'],
      },
      createdTime: '2020-06-11T01:30:22.000Z',
    },
    {
      id: 'reciuVt47krdcQgL8',
      fields: {
    ...
    {
      id: 'recm1twJ9lnbf5nN4',
      fields: {
        Name: 'HGH injection device',
        Client: ['recd7E3KRY2poUeav'],
        Category: 'Healthcare design',
        Complete: true,
        'Project team': [
          {
        ...
        Notes:
          'Healthcare giant Avi Gilly and Company has announced plans to market a human growth hormone (HGH) injection device. There are many reasons why one may seek HGH therapy, from hormone deficiencies to chronic kidney disease. This new design aims to make it quicker, simpler, and less painful for HGH therapy patients to receive their injections.\n',
        'Project lead': {
          id: 'usr3VLCpyqgcI46Sh',
          email: 'katherineduh+collab10@demo.htable.com',
          name: 'Gal Samari',
    ...
    {
      id: 'recpME7ojl1uFVuXX',
      fields: {
        Name: 'CMCA brand identity',
        Client: ['rec3ivw48crzFwF1c'],
        Category: 'Brand identity',
        'Project team': [
          {
            id: 'usr6hWARwVNgmt3WW',
